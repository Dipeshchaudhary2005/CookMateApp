...
class FetchServices {
  static Future<List<Map<String, List<String>>>?> getCuisines(BuildContext context) async {
    try {
      final url = Uri.https(StaticClass.serverBaseURL, '${StaticClass.serverApiURL}/fetch/cuisines');
